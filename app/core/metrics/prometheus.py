...
if PROMETHEUS_AVAILABLE:
    ...
    upstream_requests_total = Counter(
        "openhub_upstream_requests_total",
        "Total upstream requests",
        ["account_id", "status"],
        registry=REGISTRY,
    )
    upstream_transport_decisions_total = Counter(
        "openhub_upstream_transport_decisions_total",
    ...
    active_connections = Gauge(
        "openhub_active_connections",
        "Active HTTP connections",
        registry=REGISTRY,
        **_gauge_kwargs,
    )
    rate_limit_hits_total = Counter(
        "openhub_rate_limit_hits_total",
        "Rate limit hits",
        ["type"],
        registry=REGISTRY,
    )
    circuit_breaker_state = Gauge(
        "openhub_circuit_breaker_state",
    ...
    account_cap_rejections_total = Counter(
        "openhub_account_cap_rejections_total",
