...
describe("useDashboardPreferencesStore", () => {
  ...
  it("defaults account view mode to cards", async () => {
    ...
    expect(window.localStorage.getItem("openhub-dashboard-account-view-mode")).toBe("cards");
    expect(window.localStorage.getItem("openhub-dashboard-account-list-sort")).toBeNull();
  });
  ...
  it("persists account view mode updates", async () => {
    ...
    expect(window.localStorage.getItem("openhub-dashboard-account-view-mode")).toBe("list");
  });
  ...
  it("persists account list sort updates", async () => {
    ...
    expect(window.localStorage.getItem("openhub-dashboard-account-list-sort")).toBe(
  ...
  it("restores stored account list sort on initialization", async () => {
    window.localStorage.setItem(
      "openhub-dashboard-account-list-sort",
