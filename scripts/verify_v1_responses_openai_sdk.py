...
Drives the official `openai` Python SDK against a running openhub instance
...
Usage:
    # 1. Boot openhub locally (with the fix branch checked out)
    cd ~/projects/openhub
