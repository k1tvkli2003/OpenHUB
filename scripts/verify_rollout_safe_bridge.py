...
def _parse_args() -> VerifyConfig:
    ...
    parser.add_argument("--host", default="openhub.localtest.me")
    ...
    parser.add_argument("--rollout-namespace", default="openhub-e2e")
    parser.add_argument("--rollout-context", default="kind-openhub-local")
    parser.add_argument("--rollout-target", default="statefulset/openhub-e2e-workload")
    parser.add_argument("--delete-owner-after-first-turn", action="store_true")
    parser.add_argument("--postgresql-pod", default="openhub-e2e-postgresql-0")
    parser.add_argument("--postgresql-user", default="openhub")
    parser.add_argument("--postgresql-database", default="openhub")
    parser.add_argument("--postgresql-secret", default="openhub-e2e-postgresql")
