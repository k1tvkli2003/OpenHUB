...
- Clients that do not retry abnormal WebSocket closes will see a transport interruption instead of openhub masking the upstream disconnect. This is safer than silently mixing response generations.
